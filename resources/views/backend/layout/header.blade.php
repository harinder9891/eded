    ...
    <div class="container-fluid">
        <div class="d-flex">
            <a class="header-brand" href="{{('/')}}">
                <img src={{asset("common/assets/images/brand/logo.png")}} class="header-brand-img" alt="Lmslist logo">
            </a>
            ...
            <div class="d-flex order-lg-2 ml-auto">
                ...
                <!-- <div class="dropdown d-none d-md-flex country-selector">
                    <a href="#" class="d-flex nav-link leading-none" data-toggle="dropdown">
                        <img src={{asset("common/assets/images/flags/us_flag.jpg")}} alt="img" class="avatar avatar-xs mr-1 align-self-center">
                        <div>
                    ...
                    <div class="language-width dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                        <a href="#" class="dropdown-item d-flex pb-3">
                            <img src={{asset("common/assets/images/flags/french_flag.jpg")}} alt="flag-img" class="avatar mr-3 align-self-center" >
                            <div>
                                <strong>French</strong>
                            </div>
                        </a>
                        <a href="#" class="dropdown-item d-flex pb-3">
                            <img src={{asset("common/assets/images/flags/germany_flag.jpg")}} alt="flag-img" class="avatar mr-3 align-self-center" >
                            <div>
                                <strong>Germany</strong>
                            </div>
                        </a>
                        <a href="#" class="dropdown-item d-flex pb-3">
                            <img src={{asset("common/assets/images/flags/italy_flag.jpg")}} alt="flag-img" class="avatar mr-3 align-self-center" >
                            <div>
                                <strong>Italy</strong>
                            </div>
                        </a>
                        <a href="#" class="dropdown-item d-flex pb-3">
                            <img src={{asset("/common/assets/images/flags/russia_flag.jpg")}} alt="flag-img" class="avatar mr-3 align-self-center" >
                            <div>
                                <strong>Russia</strong>
                            </div>
                        </a>
                        <a href="#" class="dropdown-item d-flex pb-3">
                            <img src={{asset("/common/assets/images/flags/spain_flag.jpg")}} alt="flag-img" class="avatar mr-3 align-self-center" >
                            <div>
                                <strong>Spain</strong>
                            </div>
                        </a>
                ...
                <div class="dropdown d-none d-md-flex">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                        <a href="#" class="dropdown-item d-flex pb-3">
                            <img src={{asset("common/assets/images/users/male/41.jpg")}} alt="avatar-img" class="avatar brround mr-3 align-self-center">
                            <div>
                        ...
                        <a href="#" class="dropdown-item d-flex pb-3">
                            <img src={{asset("common/assets/images/users/female/1.jpg")}} alt="avatar-img" class="avatar brround mr-3 align-self-center">
                            <div>
                        ...
                        <a href="#" class="dropdown-item d-flex pb-3">
                            <img src={{asset("/common/assets/images/users/male/18.jpg")}} alt="avatar-img" class="avatar brround mr-3 align-self-center">
                            <div>
                        ...
                        <a href="#" class="dropdown-item d-flex pb-3">
                            <img src={{asset("common/assets/images/users/female/18.jpg")}} alt="avatar-img" class="avatar brround mr-3 align-self-center">
                            <div>
