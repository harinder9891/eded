        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-xl-8 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ url('admin/reviews/'.$reviewById->id) }}"
								...
								<div class="row ">
                                    ...
                                    <div class="col-sm-9">
										<select class="form-control custom-select" name="category_id">
                                            ...
                                            <option value={{$cat->id}} {{$reviewById->category->id == $cat->id ? 'selected':''}}>{{$cat->category}}</option>
                                            @endforeach
                                        </select>
									</div>
								</div>
                            ...
                            <div class="form-group">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="title" class="form-control" required value="{{$reviewById->title}}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="designation" class="form-control" value="{{$reviewById->designation}}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" name="rating" class="form-control" value="{{$reviewById->rating}}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row ">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="description" id="description">{{ $reviewById->description}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
