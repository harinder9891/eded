                ...
                <div class="card">
                    <div class="card-body">
                        <div class="tab-content">
                            <form action="{{ url('/admin/team') }}" method="POST" enctype="multipart/form-data" id="form">
                                @csrf
                                    ...
                                    <div class="table-responsive">
                                        <div class="control-group form-group">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Member Name" name="member_name" required value="{{old('member_name')}}" />
                                            </div>
