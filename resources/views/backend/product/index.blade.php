                        ...
                        <div class="ads-tabs">
                            <div class="tabs-menus">
                                ...
                                <ul class="nav panel-tabs">
                                    <li class=""><a href="#tab1" class="active" data-toggle="tab">All Products {{"(".count($products).")"}}</a></li>
                                ...
                                <div class="tab-pane active table-responsive border-top userprof-tab" id="tab1">
                                    <table class="table table-bordered table-hover mb-0 text-nowrap display nowrap" id="example">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><input type="checkbox" class='check' id='check' value="{{$product->id}}"></td>

                                                <td>
                                                    <div class="media mt-0 mb-0">
                                                        <h4 class="font-weight-semibold">{{ $product->title}}</h4>
                                                    </div>
                                                </td>

                                                
                                                <td>
                                                <a href="{{url('/admin/products/'.$product->id.'/edit')}}" class="btn btn-success btn-sm text-white" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-pencil"></i></a>
